...
- **상대 파악:** ✅ ① 상대 자유서술 입력 → AI(interpret)가 상대 성향(애착·관심도·주의 신호) 추론해 해석·문구 반영. ② 진단 마지막 **'카톡 캡처 분석'**(최대 3장, 클라 1024px 리사이즈 → `/api/analyze-images` Sonnet 4.6 비전, 위기 케이스 제외, **유료 옵션 예정**). 둘 다 점수 미반영.
